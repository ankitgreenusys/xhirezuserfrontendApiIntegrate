      ...
      <div className="profilesec marginframe">
        ...
        <div className="profiledetails">
          <div className="atextbox my-3 basicdetail">
            ...
            <div className="d-flex detarea">
              ...
              <div className="detdata">
                <h2>
                  {loggedUser?.userId?.firstName} {loggedUser?.userId?.lastName}
                </h2>
                <h5>
                  <i class="fa-solid fa-briefcase me-3"></i>
                  {loggedUser?.currentJob} at {loggedUser?.currentEmployer}
                </h5>
                <h5>
                ...
                <h5>
                  <i class="fa-solid fa-envelope me-3"></i>{loggedUser?.userId?.email}
                </h5>
                <h5>
                  <i class="fa-solid fa-phone me-3"></i>{loggedUser?.userId?.number}
                </h5>
              </div>
            </div>
          </div>
          <div className="atextbox my-3">
            <div className="d-flex justify-content-between align-items-center">
              <div className="topic txt-blue">| {loggedUser?.currentJob}</div>
              ...
              <div className="workexp d-flex align-items-center">
                ...
                <div className="details">
                  ...
                  <div className="duration">
                    Bhopal University - UG Education
                  </div>
                </div>
              </div>
              <div className="workexp d-flex align-items-center">
                ...
                <div className="details">
                  ...
                  <div className="duration">
                    Punjab University - PG Education
                  </div>
                </div>
              </div>
              <div className="workexp d-flex align-items-center">
